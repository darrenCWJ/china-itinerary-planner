/**
 * ingest-climate — the three pure functions, and the measured fixtures they
 * are checked against.
 *
 ...
 * along its section banners. Every fixture and describe below is that file's,
 * unchanged; only the import path moved with them. The grid and scaling
 * constants are transcribed from `data/climate-probe.md`, which is the
 * measured authority — where this file and that document disagree, the
 * document wins.
 */

import { describe, expect, test } from "vitest";
import { decodeSample, pixelFor, tupleFor } from "./sample.mjs";
